...
echo "Using custom files in folder: $CUSTOM_FILES"
...
# 	echo "found password \"$SERVER_PASSWORD\""
...
# cp -RT /home/cs2/custom_files/ /home/${user}/cs2/game/csgo/
