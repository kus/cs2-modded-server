...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `164` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[SharpTimer](https://github.com/DEAFPS/SharpTimer/)| `0.2.1` | SharpTimer is a simple Surf/KZ/Bhop/MG/Deathrun/etc CS2 Timer plugin
