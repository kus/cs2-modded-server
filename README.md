...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `162` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[SharpTimer](https://github.com/DEAFPS/SharpTimer/)| `0.2.0` | SharpTimer is a simple Surf/KZ/Bhop/MG/Deathrun/etc CS2 Timer plugin
[GunGame](https://github.com/ssypchenko/cs2-gungame)| `1.0.6` | GunGame mode on Counter Strike Sharp
...
[CS2 Retakes](https://github.com/B3none/cs2-retakes)| `1.3.26` | CS2 implementation of retakes. Based on the version for CS:GO by Splewis.
...
[CS2 Retakes Allocator](https://github.com/yonilerner/cs2-retakes-allocator)| `1.2.14` | Advanced weapon allocation for B3none/cs2-retakes
