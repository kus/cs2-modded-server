...
Mod | Version | Why
--- | --- | ---
[Metamod:Source](https://www.metamodsource.net/downloads.php?branch=dev) | `2.0.0-1328` | Sits between the Game and the Engine, and allows plugins to intercept calls that flow between
...
[MultiAddonManager](https://github.com/Source2ZE/MultiAddonManager) | `1.3.4` | Allows you to use multiple workshop addons at once and have clients download them
...
[K4-Arenas](https://github.com/KitsuneLab-Development/K4-Arenas)| `2.0.3` | All in one arena plugin, that you can use to have a ladder type gameplay. Support all map, 2v2/3v3/etc
