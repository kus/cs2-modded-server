...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `259` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[MatchZy](https://github.com/shobhit-pathak/MatchZy) | `0.8.1` | MatchZy is a plugin for CS2 for running and managing practice/pugs/scrims/matches with easy configuration!
...
[CS2-CustomVotes](https://github.com/imi-tat0r/CS2-CustomVotes)| `1.1.2` | A plugin for Counter-Strike 2 to create custom votes for settings.
