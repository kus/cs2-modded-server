...
[GameModeManager](https://github.com/nickj609/GameModeManager)| `1.0.48` | A simple Counter-Strike 2 server plugin that helps admins manage game modes and map groups.
...
[K4-Arenas](https://github.com/KitsuneLab-Development/K4-Arenas)| `1.5.1` | All in one arena plugin, that you can use to have a ladder type gameplay. Support all map, 2v2/3v3/etc
[CS2 Retakes](https://github.com/B3none/cs2-retakes)| `20.0.15` | CS2 implementation of retakes. Based on the version for CS:GO by Splewis.
[CS2 Retakes Shared](https://github.com/B3none/cs2-retakes)| `20.0.15` | Shared library for CS2 Retakes.
...
[CS2 Deathmatch](https://github.com/NockyCZ/CS2-Deathmatch)| `1.2.2` | Custom Deathmatch CS2 plugin (Includes custom spawnpoints, multicfg, gun selection, spawn protection, etc)
