...
Mod | Version | Why
--- | --- | ---
[Metamod:Source](http://www.sourcemm.net/downloads.php?branch=master) | `2.0.0-1281` | Sits between the Game and the Engine, and allows plugins to intercept calls that flow between
...
[CS2 Retakes](https://github.com/B3none/cs2-retakes)| `1.3.24` | CS2 implementation of retakes. Based on the version for CS:GO by Splewis.
