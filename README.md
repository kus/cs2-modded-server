...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `1.0.344` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[MatchZy](https://github.com/shobhit-pathak/MatchZy) | `0.8.14` | MatchZy is a plugin for CS2 for running and managing practice/pugs/scrims/matches with easy configuration!
