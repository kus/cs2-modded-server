...
[MovementUnlocker](https://github.com/Source2ZE/MovementUnlocker) | `1.6` | Removes max speed limitation from players on the ground, feels like CS:S [How?](#i-run-a-surfkzbhop-server-and-want-movementunlocker-and-cs2fixes-rampbugfix-permanently-on)
