...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `1.0.327` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[CS2WarcraftMod](https://github.com/Wngui/CS2WarcraftMod) | `3.3.0` | An open-source Warcraft mod for CS2 featuring a fully-fledged RPG system.
