...
[CS2 Deathmatch](https://github.com/NockyCZ/CS2-Deathmatch)| `1.1.5` | Custom Deathmatch CS2 plugin (Includes custom spawnpoints, multicfg, gun selection, spawn protection, etc)
