...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `265` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
