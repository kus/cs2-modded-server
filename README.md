...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `1.0.333` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
[MultiAddonManager](https://github.com/Source2ZE/MultiAddonManager) | `1.4.4` | Allows you to use multiple workshop addons at once and have clients download them
...
[Inventory Simulator](https://github.com/ianlucas/cs2-inventory-simulator-plugin)| `31` | Use any Weapon, Knife, Gloves, Agent, Music Kit, Pin or Graffiti. [How?](#skin-changer)
...
[GunGame](https://github.com/ssypchenko/cs2-gungame)| `1.2.0` | GunGame mode on Counter Strike Sharp
...
[CS2 Retakes](https://github.com/B3none/cs2-retakes)| `2.1.4` | CS2 implementation of retakes. Based on the version for CS:GO by Splewis.
...
[cs2-advanced-weapon-system](https://github.com/schwarper/cs2-advanced-weapon-system) | `1.5` | An advanced weapon system that gives full control over weapon attributes, dynamic adjustments to weapon behaviour, restrictions and advanced customisation.
