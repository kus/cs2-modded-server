...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `167` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[CS2 Deathmatch](https://github.com/NockyCZ/CS2-Deathmatch)| `1.0.6` | Custom Deathmatch CS2 plugin (Includes custom spawnpoints, multicfg, gun selection, spawn protection, etc)
