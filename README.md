...
Mod | Version | Why
--- | --- | ---
[Metamod:Source](https://www.metamodsource.net/downloads.php?branch=dev) | `2.0.0-1334` | Sits between the Game and the Engine, and allows plugins to intercept calls that flow between
...
[RollTheDice](https://github.com/Kandru/cs2-roll-the-dice) | `1.3.5` | Roll the dice to get either a positive or negative effect for the current round.
