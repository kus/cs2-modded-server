...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `242` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[GameModeManager](https://github.com/nickj609/GameModeManager)| `1.0.42` | A simple Counter-Strike 2 server plugin that helps admins manage game modes and map groups.
...
[OpenPrefirePrac](https://github.com/lengran/OpenPrefirePrac)| `0.1.37` | Multiple prefire practices on competitive maps and support multiplayer practicing simultaneously.
