...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `1.0.342` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[CS2Fixes-RampbugFix](https://github.com/Interesting-exe/CS2Fixes-RampbugFix) | `9-16` | Minimizes rampbugs (needs to be enabled via `!settings` [How?](#i-run-a-surfkzbhop-server-and-want-movementunlocker-and-cs2fixes-rampbugfix-permanently-on))
...
[Inventory Simulator](https://github.com/ianlucas/cs2-inventory-simulator-plugin) | `36` | Use any Weapon, Knife, Gloves, Agent, Music Kit, Pin or Graffiti. [How?](#skin-changer)
...
[CS2 Executes](https://github.com/zwolof/cs2-executes) | `1.1.0` | CS2 implementation of executes. Based on the version for CS:GO by Splewis.
