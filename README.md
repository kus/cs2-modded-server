...
--metadata=RCON_PASSWORD=changeme,STEAM_ACCOUNT=changeme,FAST_DL_URL=http://yourdomain/,MOD_URL=https://github.com/kus/csgo-modded-server/archive/master.zip,startup-script=\#\!/usr/bin/env\ bash$'\n'bash\ /gcp.sh \
