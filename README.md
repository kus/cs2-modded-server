...
[CounterStrikeSharp](https://github.com/roflmuffin/CounterStrikeSharp) | `227` | Attempts to implement a .NET Core scripting layer on top of a Metamod Source Plugin, allowing developers to create plugins that interact with the game server in a modern language (C#)
...
[K4-Arenas](https://github.com/K4ryuu/K4-Arenas)| `1.4.1` | All in one arena plugin, that you can use to have a ladder type gameplay. Support all map, 2v2/3v3/etc
